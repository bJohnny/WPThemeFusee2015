...
/**Define all custom acf's. ACF must be loaded before */
if(function_exists("register_field_group"))
{
    register_field_group(array (
        ...
        'fields' => array (
            array (
                'key' => 'field_55fe8fac56303',
                'label' => 'Display Slider',
                'name' => 'display_slider',
                'type' => 'true_false',
                'instructions' => 'Whether or not the slider is displayed.',
                'message' => '',
                'default_value' => 0,
            ),
            array (
                'key' => 'field_55feda8be1ae2',
                'label' => 'Display Marketing Boxes',
                'name' => 'display_marketing_boxes',
                'type' => 'true_false',
                'instructions' => 'Whether or not you want to display all Marketing Boxes.',
                'message' => '',
                'default_value' => 0,
            ),
        ),
    ...
    register_field_group(array (
        'id' => 'acf_marketing-box',
        'title' => 'Marketing Box',
        'fields' => array (
            array (
                'key' => 'field_55f7e84ca7050',
            ...
            array (
                'key' => 'field_55fad36b25f44',
                'label' => 'Text',
                'name' => 'text',
                'type' => 'wysiwyg',
                'instructions' => 'write a catchy line (128 characters)',
                'required' => 1,
                'default_value' => '',
                'toolbar' => 'basic',
                'media_upload' => 'yes',
            ...
            array (
                'key' => 'field_55fad1e87cf03',
                'label' => 'Button Text',
                'name' => 'button_text',
                'type' => 'text',
                'instructions' => 'It\'s a button text',
                'default_value' => 'Link',
                'placeholder' => '',
                'prepend' => '',
                'append' => '',
            ...
            array (
                'key' => 'field_55facf507cf00',
                'label' => 'Page Link',
                'name' => 'page_link',
                'type' => 'page_link',
                'instructions' => 'link to a site within this website',
                'conditional_logic' => array (
                    'status' => 1,
                    'rules' => array (
                        array (
                            'field' => 'field_55fad0df7cf01',
                            'operator' => '==',
                            'value' => '1',
                        ),
                    ),
            ...
            array (
                'key' => 'field_55fad1667cf02',
                'label' => 'External Link',
                'name' => 'external_link',
                'type' => 'text',
                'instructions' => 'external URL',
                'required' => 1,
                'conditional_logic' => array (
                    'status' => 1,
                    'rules' => array (
    ...
    register_field_group(array (
        ...
        'fields' => array (
            ...
            array (
                'key' => 'field_55f7ae85392ff',
                'label' => 'Responsibilities',
                'name' => 'responsibilities',
                'type' => 'text',
                'instructions' => 'Describe your responsibilities (57 characters max.)',
                'default_value' => 'Fusee Developer',
                'placeholder' => '',
                'prepend' => '',
                'append' => '',
                'formatting' => 'none',
            ...
            array (
                'key' => 'field_55f7342a30230',
                'label' => 'Facebook Profile',
                'name' => 'facebook_profile',
                'type' => 'text',
                'instructions' => 'Add URL to your profile',
                'default_value' => '',
                'placeholder' => '',
                'prepend' => '',
                'append' => '',
    ...
    register_field_group(array (
        'id' => 'acf_fusee-examples',
        'title' => 'Fusee Examples',
        'fields' => array (
            array (
                'key' => 'field_55fd6bf367c66',
                'label' => 'Image',
                'name' => 'image',
                'type' => 'image',
                'save_format' => 'url',
            ...
            array (
                'key' => 'field_55fd6c6f1b3a3',
                'label' => 'Standalone Executable',
                'name' => 'standalone_executable',
                'type' => 'text',
                'instructions' => 'Enter URL to File.',
                'default_value' => '',
                'placeholder' => '',
                'prepend' => '',
                'append' => '',
            ...
            array (
                'key' => 'field_55fd6d2d1b3a6',
                'label' => 'HTML5 Version',
                'name' => 'html5_version',
                'type' => 'text',
                'instructions' => 'Enter URL',
                'conditional_logic' => array (
                    'status' => 1,
                    'rules' => array (
                        array (
                            'field' => 'field_55fd70670684c',
                            'operator' => '==',
                            'value' => 'html5',
                        ),
                    ),
